...
"easy-image-grid-maker-guide.md": {
	id: "easy-image-grid-maker-guide.md";
  slug: "easy-image-grid-maker-guide";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"simple-grid-generator-guide.md": {
	id: "simple-grid-generator-guide.md";
  slug: "simple-grid-generator-guide";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
